...
interface SubscriptionSoftContinueProps {
  data: subscriptionType;
}
export const SubscriptionSoftContinue = ({
  data,
}: SubscriptionSoftContinueProps) => {
            ...
            <KeyValText
              ...
              val={
                <span className="text-main-color">
                  {data.softInfo?.softKey || 'не зареєстровано'}
                </span>
              }
              ...
              icon={
                <Button
                  ...
                  onClick={() => copy(data.softInfo?.softKey || '')}
                >
            ...
            <>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                <KeyValText
                  ...
                  className="mb-4 justify-between hidden sm:flex"
                  icon={
                    <Button
                      type="button"
                      variant="ghost"
