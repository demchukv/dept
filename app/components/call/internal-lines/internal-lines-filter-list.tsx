...
const filterList = [
  { key: 'alphabet', value: 'за алфавітом' },
  { key: 'lineNumber', value: 'за номером лінії' },
  { key: 'dateCreatedAt', value: 'за датою створення' },
];
export const InternalLinesFilterList = ({
  onSort,
  sortKey,
}: {
  ...
  return (
    <>
      <div className="hidden md:flex items-center leading-main-lh">
      ...
      <Button
        type="button"
        variant="ghost"
        className="text-main-color w-6 h-6 md:hidden"
