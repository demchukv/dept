    ...
    <ModalOverlay>
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'z-50 grid grid-cols-1 gap-4 justify-center items-center h-full w-full min-w-[319px] max-w-[616px] md:max-w-[640px] border-none rounded-[6px] bg-white p-0 shadow-[6px_6px_40px_0_rgba(89,125,137,0.1)]',
...
const ModalInner = ({
  ...
  <div
    className={cn('p-3 xs:p-4 sm:p-9 pt-0 xs:pt-0 sm:pt-0', className)}
    {...props}
  />
);
...
const ModalHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col justify-end text-center sm:text-left p-3 xs:p-4 sm:p-9 pt-9 xs:pt-9 sm:pt-9',
      className,
    )}
    {...props}
  />
...
const ModalFooter = ({
  ...
  <div
    className={cn(
      'flex gap-2 p-3 xs:p-4 sm:p-9 shadow-[0_-6px_20px_0_rgba(89,125,137,0.08)]',
      className,
    )}
    {...props}
  />
