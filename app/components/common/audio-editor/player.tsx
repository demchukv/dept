...
export default function Player({
  ...
  return (
    <div className="relative block h-40 shadow-[0_0_30px_rgba(0,0,0,.1)]">
      ...
      >
        <div className="absolute top-[-22px] text-xs py-[1px] px-[3px] text-center text-white bg-[#0cf] [transform:translate(-50%)_scale(0.8)]">
