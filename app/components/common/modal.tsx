    ...
    <ModalOverlay>
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'z-50 grid grid-cols-1 gap-4 justify-center items-center w-full min-w-[319px] max-w-[616px] border-none rounded-[6px] bg-white p-4 xs:p-9 shadow-[6px_6px_40px_0_rgba(89,125,137,0.1)]',
